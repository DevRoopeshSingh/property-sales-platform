      ...
      <section className="relative overflow-hidden bg-slate-900">
        ...
        <div className="container-main relative z-10 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            {/* Advanced Search Bar */}
            <div className="mb-8 animate-fade-up relative z-20" style={{ animationDelay: "0.3s" }}>
              <HeroSearchClient locations={activeLocations} />
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-up relative z-10" style={{ animationDelay: "0.4s" }}>
              <Link href="/properties" className="btn btn-primary px-8 py-3.5 text-base w-full sm:w-auto flex justify-center text-center">
                Browse Verified Properties
              </Link>
              <a href={waLink} target="_blank" rel="noopener noreferrer" className="btn border-white/40 text-white hover:bg-white/10 px-8 py-3.5 text-base w-full sm:w-auto border-2 flex justify-center items-center gap-2">
